...
function speechOnGoogleHome(ghName, params) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                setTimeout(() => reject('TIMEOUT speechOnGoogleHome'), 120000);
                let path_togo = ((_a = params.outFile) !== null && _a !== void 0 ? _a : getNowDateWithString()) + ".wav";
                // 日付時刻から保存パス設定
                ...
                yield gtts.getTtsAudioData(params).catch((err) => reject(err));
                console.log(`params.rb_effects1 = ${params.rb_effects1}`);
                let rb_effects1_array = [
                    {
                        key: 'hankyo',
                ...
                if (ghName)
                    yield gHome.play(ghName, fullPathUrl, params).then((d) => resolve(d)).catch((err) => reject(err));
                else
                    resolve(params);
            }
            catch (err) {
...
function getCalJson(sdate = undefined, edate = undefined) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getCalDayBetweenJson(date1, date2) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return gtts.getCalJson(localdate0.toLocaleDateString().substring(0, 10).split("/").join("-"), localdate1.toLocaleDateString().substring(0, 10).split("/").join("-"));
    });
}
function getCalJsonReturnToText(g, dayx = undefined) {
    const textparams = [
        {
...
function speechOnGoogleHomeCal(ghName, params) {
    return __awaiter(this, void 0, void 0, function* () {
        let stay_loop = true;
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            for (let i = 0; stay_loop && i < 10; i++) {
                stay_loop = false;
                yield getCalJson().then((g) => __awaiter(this, void 0, void 0, function* () {
                    params.text = getCalJsonReturnToText(g);
                    params.volume = 80;
                    params.voiceTypeId = Math.floor(Math.random() * 4);
                    params.pitch = Math.random() * 10 - 5;
                    console.log(params.text);
                    yield speechOnGoogleHome(ghName, params).then(d => resolve(d)).catch(er => reject(er));
                })).catch(er => {
                    console.log(er);
                    stay_loop = true;
                });
...
//# sourceMappingURL=google_home.js.map